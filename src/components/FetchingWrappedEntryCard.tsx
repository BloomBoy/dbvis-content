...
import { CustomEntityCardProps, RenderCustomMissingEntityCard, useEntity, useEntityLoader, WrappedEntryCard, MissingEntityCard } from '@contentful/field-editor-reference';
import type { SingleEntryReferenceEditor, CombinedLinkActions } from '@contentful/field-editor-reference';
import type {
  ContentType,
  FieldExtensionSDK,
  NavigatorSlideInfo,
...
type RenderDragFn = (props: {
  drag: React.ReactElement;
  isDragging?: boolean;
}) => React.ReactElement;

type LinkActionsProps = React.ComponentPropsWithoutRef<typeof CombinedLinkActions>;
type WrappedEntryCardProps = React.ComponentPropsWithoutRef<typeof WrappedEntryCard>;
type ReferenceEditorProps =  React.ComponentPropsWithoutRef<typeof SingleEntryReferenceEditor>;
...
export function FetchingWrappedEntryCard(props: EntryCardReferenceEditorProps) {
  ...
  return React.useMemo(() => {
    ...
    function renderDefaultCard(props?: CustomEntityCardProps) {
      const contentType = (props?.contentType || sharedCardProps.contentType);
